...
def build_architecture(input_shape,
    ...
    model.add(Conv2D(64, (3, 3), padding='same', name='block4_conv2'))
    model.add(Activation('relu', name='block4_relu2'))             
    model.add(BatchNormalization())
    model.add(Conv2D(64, (3, 3), padding='same', name='block4_conv3'))
    ...
    model.add(BatchNormalization())
    model.add(Conv2D(64, (3, 3), padding='same', name='block5_conv2'))
    model.add(Activation('relu', name='block5_relu2'))              
    model.add(BatchNormalization())
    model.add(Conv2D(64, (3, 3), padding='same', name='block5_conv3'))
